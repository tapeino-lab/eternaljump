...
import { RND, FLR, MAX, MIN, $, getPlayerName } from "./utils.js";
import { addPlatform, getSafetyLineY, isInMushroomForbiddenZone } from './spawner.js';
...
export function resetGameState(isConsecutive) {
  ...
  fireworksSystem.reset();
  airplaneSystem.reset();
