...
export async function startDemoRankingScroll(isAttractMode: boolean, mode: 'ta' | 'height' = 'height', isTransition: boolean = false) {
  ...
  let headerHtml = `<table style="width:100%;table-layout:fixed;border-collapse:collapse;font-size:9px;"><tr style="color:rgba(255,255,255,0.85);font-size:8px;"><th style="padding:4px 0;text-align:left;width:24px;padding-left:4px;vertical-align:middle;font-weight:normal;">#</th><th style="padding:4px 0;text-align:center;width:32px;vertical-align:middle;font-weight:normal;">LANG</th><th style="padding:4px 0;width:4px;padding:0;vertical-align:middle;font-weight:normal;"></th><th style="padding:4px 0;text-align:center;width:36px;vertical-align:middle;font-weight:normal;">NAME</th><th style="padding:4px 0;text-align:center;vertical-align:middle;font-weight:normal;">${mode === 'ta' ? 'TIME' : 'HEIGHT'}</th>${mode === 'ta' ? '' : '<th style="padding:4px 0;width:32px;padding-right:4px;vertical-align:middle;font-weight:normal;"><div style="display:flex;justify-content:center;align-items:center;height:8px;"><div class="coin-icon"><div class="c-p1"></div><div class="c-p2"></div><div class="c-p3"></div></div></div></th>'}</tr></table>`;
